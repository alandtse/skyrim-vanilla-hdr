...
cbuffer cb2 : register(b2) { float4 cb2[11]; }

cbuffer cb12 : register(b12) { float4 cb12[45]; }
...
void main(float4 v0
  ...
  if (r0.x != 0) {
    ...
    r4.xyz = floor(r4.xyz);
    r3.xyz =
        r3.xyz * float3(0.0700000003, 0.0700000003, 0.0700000003) + -r4.xyz;
    ...
    r11.xyzw =
        float4(0.00346020772, 0.00346020772, 0.00346020772, 0.00346020772) *
        r10.xyzw;
    ...
    r5.xyzw = float4(0.0204081647, 0.0204081647, 0.0204081647, 0.0204081647) *
              r4.xyzw;
    r5.xyzw = floor(r5.xyzw);
    r4.xyzw = -r5.xyzw * float4(49, 49, 49, 49) + r4.xyzw;
    r5.xyzw =
        float4(0.142857149, 0.142857149, 0.142857149, 0.142857149) * r4.xyzw;
    r5.xyzw = floor(r5.xyzw);
    r4.xyzw = -r5.xyzw * float4(7, 7, 7, 7) + r4.xyzw;
    r5.xyzw =
        r5.xyzw * float4(0.285714298, 0.285714298, 0.285714298, 0.285714298) +
        float4(-0.928571403, -0.928571403, -0.928571403, -0.928571403);
    r4.xyzw =
        r4.xzyw * float4(0.285714298, 0.285714298, 0.285714298, 0.285714298) +
        float4(-0.928571403, -0.928571403, -0.928571403, -0.928571403);
    ...
    r4.xyzw =
        -r11.xyzw * float4(0.853734732, 0.853734732, 0.853734732, 0.853734732) +
        float4(1.79284286, 1.79284286, 1.79284286, 1.79284286);
    ...
    r11.xyzw =
        float4(0.600000024, 0.600000024, 0.600000024, 0.600000024) + -r11.xyzw;
...
void main(float4 v0
  ...
  r0.w = r0.z * 1.00999999 + -0.00999999978;
  r0.z = cmp(r0.z < 0.999998987);
  r0.w = r0.w * 2 + -1;
  r1.x = cb2[3].y + cb2[3].x;
  r1.y = cb2[3].y + -cb2[3].x;
  r0.w = -r0.w * r1.y + r1.x;
  r1.x = dot(cb2[3].xx, cb2[3].yy);
  r0.w = r1.x / r0.w;
  r0.w = saturate(r0.w * cb2[0].y + -cb2[0].x);
  r0.w = log2(r0.w);
  r0.w = cb2[0].z * r0.w;
  r0.w = exp2(r0.w);
  r0.w = min(cb2[0].w, r0.w);
  r1.xyz = cb2[2].xyz + -cb2[1].xyz;
  r1.xyz = r0.www * r1.xyz + cb2[1].xyz;
  r1.w = t1.Sample(s1_s, r0.xy).x;
